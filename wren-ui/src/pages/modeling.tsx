...
export default function Modeling() {
  ...
  useEffect(() => {
    if (data) diagramRef.current?.fitView();
  }, [data]);
  ...
  const [createCalculatedField, { loading: calculatedFieldCreating }] =
    useCreateCalculatedFieldMutation(
      getBaseOptions({
        onError: null,
        onCompleted: () => {
          message.success('Campo calculado criado com sucesso.');
        },
      }),
    );
  ...
  const [updateCalculatedField, { loading: calculatedFieldUpdating }] =
    useUpdateCalculatedFieldMutation(
      getBaseOptions({
        onError: null,
        onCompleted: () => {
          message.success('Campo calculado atualizado com sucesso.');
        },
      }),
    );
  ...
  const [deleteCalculatedField] = useDeleteCalculatedFieldMutation(
    getBaseOptions({
      onCompleted: () => {
        message.success('Campo calculado excluído com sucesso.');
      },
    }),
  );
  ...
  const [deleteViewMutation] = useDeleteViewMutation(
    getBaseOptions({
      onCompleted: () => {
        message.success('View excluída com sucesso.');
      },
    }),
  );
  ...
  const [updateModelMetadata, { loading: modelMetadataUpdating }] =
    useUpdateModelMetadataMutation(
      getBaseOptions({
        onCompleted: () => {
          message.success('Metadados do modelo atualizados com sucesso.');
        },
      }),
    );
  ...
  const [createRelationshipMutation, { loading: relationshipCreating }] =
    useCreateRelationshipMutation(
      getBaseOptions({
        onCompleted: () => {
          message.success('Relacionamento criado com sucesso.');
        },
      }),
    );
  ...
  const [deleteRelationshipMutation] = useDeleteRelationshipMutation(
    getBaseOptions({
      onCompleted: () => {
        message.success('Relacionamento excluído com sucesso.');
      },
    }),
  );
  ...
  const [updateRelationshipMutation, { loading: relationshipUpdating }] =
    useUpdateRelationshipMutation(
      getBaseOptions({
        onCompleted: () => {
          message.success('Relacionamento atualizado com sucesso.');
        },
      }),
    );
  ...
  const [updateViewMetadata, { loading: viewMetadataUpdating }] =
    useUpdateViewMetadataMutation(
      getBaseOptions({
        onCompleted: () => {
          message.success('Metadados da view atualizados com sucesso.');
        },
      }),
    );
  ...
  const queryParams = {
    viewId:
      typeof router.query.viewId === 'string' ? router.query.viewId : undefined,
    openMetadata:
      typeof router.query.openMetadata === 'string'
