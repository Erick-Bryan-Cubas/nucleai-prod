...
import { LLMConfigResolver } from './resolvers/llmConfigResolver';
...
const llmConfigResolver = new LLMConfigResolver();
const resolvers = {
  JSON: GraphQLJSON,
  ...
  Query: {
    ...
    // NucleAI: LLM Config
    llmConfig: llmConfigResolver.getLLMConfig,
    listOllamaModels: llmConfigResolver.listOllamaModels,
  },
  Mutation: {
    ...
    // NucleAI: LLM Config
    updateLLMConfig: llmConfigResolver.updateLLMConfig,
    testLLMConnection: llmConfigResolver.testLLMConnection,
    probeOllamaEmbeddingDim: llmConfigResolver.probeOllamaEmbeddingDim,

    // NucleAI: API History maintenance
    deleteApiHistory: apiHistoryResolver.deleteApiHistory,
  },
