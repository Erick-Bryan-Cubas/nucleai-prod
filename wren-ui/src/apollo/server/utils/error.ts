...
export const errorMessages = {
  ...
  [GeneralErrorCodes.INVALID_SQL_ERROR]:
    'O SQL gerado não é compatível com o engine de consulta. Tente reformular a pergunta ou regenere a resposta.',

  // wren engine error (real connection/internal failure)
  [GeneralErrorCodes.WREN_ENGINE_ERROR]:
    'Erro interno ao consultar o wren-engine. Verifique se o serviço está disponível.',
...
export const shortMessages = {
  ...
  [GeneralErrorCodes.DEPLOY_SQL_PAIR_ERROR]: 'Deploy sql pair error',
  [GeneralErrorCodes.GENERATE_QUESTIONS_ERROR]: 'Generate questions error',
  [GeneralErrorCodes.INVALID_SQL_ERROR]: 'SQL incompatível com o engine',
  [GeneralErrorCodes.WREN_ENGINE_ERROR]: 'Falha no wren-engine',
