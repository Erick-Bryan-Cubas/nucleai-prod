...
export type DeleteApiHistoryMutationVariables = Types.Exact<{
  ids: Array<Types.Scalars['String']> | Types.Scalars['String'];
}>;

export type DeleteApiHistoryMutation = {
  __typename?: 'Mutation';
  deleteApiHistory: number;
};

export const DeleteApiHistoryDocument = gql`
  mutation DeleteApiHistory($ids: [String!]!) {
    deleteApiHistory(ids: $ids)
  }
`;

export function useDeleteApiHistoryMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteApiHistoryMutation,
    DeleteApiHistoryMutationVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<
    DeleteApiHistoryMutation,
    DeleteApiHistoryMutationVariables
  >(DeleteApiHistoryDocument, options);
}
export type DeleteApiHistoryMutationHookResult = ReturnType<
  typeof useDeleteApiHistoryMutation
>;
export type DeleteApiHistoryMutationResult =
  Apollo.MutationResult<DeleteApiHistoryMutation>;
export type DeleteApiHistoryMutationOptions = Apollo.BaseMutationOptions<
  DeleteApiHistoryMutation,
  DeleteApiHistoryMutationVariables
>;
