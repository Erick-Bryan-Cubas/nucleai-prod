  ...
  useEffect(() => {
    ...
    try {
      ...
      setParsedError({
        ...
        shortMessage: 'Não foi possível renderizar o gráfico',
        ...
        <Alert
          ...
          message={
            <div className="d-flex align-center justify-space-between">
              <div>
                Há categorias demais para exibir com clareza. Clique em
                &nbsp;"Mostrar top 25" para ver os principais resultados ou faça
                uma pergunta complementar para filtrar melhor.
              </div>
              <Button
                size="small"
                icon={<EyeOutlined />}
    ...
    >
      {isAdditionalShow && (
        <div className="adm-chart-additional d-flex justify-content-between align-center">
          {!!onReload && (
            <Tooltip title="Regenerar gráfico">
          ...
          {!!onPin && (
            <Tooltip title="Fixar gráfico no dashboard">
