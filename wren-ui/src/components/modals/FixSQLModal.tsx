...
export function FixSQLModal(props: Props) {
  ...
  const error = useMemo(() => {
    ...
    return { ...graphQLError, shortMessage: 'Sintaxe SQL inválida' };
  ...
  return (
    <Modal
      ...
      afterClose={reset}
    >
      <Typography.Text className="d-block mb-3" style={{ color: 'var(--gray-6)' }}>
        A instrução SQL a seguir precisa ser corrigida:
      </Typography.Text>
