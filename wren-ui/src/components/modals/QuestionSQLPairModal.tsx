...
export default function QuestionSQLPairModal(props: Props) {
  ...
  return (
    <>
      <Modal
        title={`${isCreateMode ? 'Adicionar' : 'Atualizar'} par Pergunta-SQL`}
        centered
        closable
        ...
        footer={
          <div className="d-flex justify-space-between align-center">
            ...
            >
              ...
              >
                A instrução SQL aqui utiliza <b>Wren SQL</b>, baseado em ANSI SQL e otimizado para o Wren AI.{` `}
                <Typography.Link
                  type="secondary"
      ...
      >
        <StyledForm form={form} preserve={false} layout="vertical">
          <Form.Item
            ...
            label={
              ...
              >
                <span>Pergunta</span>
                <div className="text-sm" style={{ color: 'var(--gray-5)' }}>
                  Deixe a IA criar uma pergunta correspondente para esta instrução SQL.
                  <Button
                    className="ml-2"
                    size="small"
                    ...
                    disabled={disabled}
                  >
                    <span className="text-sm">Gerar pergunta</span>
                  </Button>
                </div>
              </div>
            }
        ...
        <div className="my-3">
          <Typography.Text className="d-block mb-2" style={{ color: 'var(--gray-6)' }}>
            Pré-visualização de dados (50 linhas)
          </Typography.Text>
          <Button
