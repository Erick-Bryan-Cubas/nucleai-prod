...
export default function AddCalculatedFieldModal(props: Props) {
  ...
  return (
    <Modal
      title={`${isEditMode ? 'Atualizar' : 'Adicionar'} campo calculado`}
      width={750}
      visible={visible}
      onCancel={onClose}
      ...
      footer={
        <div className="d-flex justify-space-between align-center">
          <div className="text-sm ml-2">
            <LinkOutlined className="mr-2" style={{ color: 'var(--gray-6)' }} />
            <Typography.Link
              type="secondary"
            ...
            >
              Como definir a chave primária em um modelo.
            </Typography.Link>
          </div>
          <div>
    ...
    >
      <Form form={form} preserve={false} layout="vertical">
        ...
        >
          <DescriptiveSelector
            placeholder="Selecione uma expressão"
