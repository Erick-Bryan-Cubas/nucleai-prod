        ...
        <>
          ...
          {relation.isAutoGenerated && (
            <Text className="pl-1" type="secondary">
              {t('defineRelations.autoGenerated')}
            </Text>
          )}
        </>
      ),
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size={[16, 0]}>
          ...
          />
          <Popconfirm
            title={t('defineRelations.confirmDelete')}
            okText={t('defineRelations.delete')}
      ...
      <ModelRelationSelectionTable
        ...
        extra={(onCollapseOpen) => (
          <Button
            ...
            size="small"
            title={t('defineRelations.addRelationship')}
          >
            <PlusOutlined />
            {t('defineRelations.add')}
          </Button>
        )}
  ...
  return (
    <div>
      <Title level={1} className="mb-3">
        {t('defineRelations.title')}
      </Title>
      <Text>
        {t('defineRelations.description')}
      </Text>
      {showNoRecommendationAlert && (
        <Alert
          message={t('defineRelations.noRecommendedTitle')}
          description={t('defineRelations.noRecommendedDescription')}
          type="info"
          showIcon
          className="my-6"
        />
      ...
      <div className="my-6 text-center">
        ...
        <Spin spinning={fetching} tip={t('common.loading')} className="my-15" />
      </div>
