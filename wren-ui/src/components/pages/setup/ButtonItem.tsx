...
const StyledButton = styled(Button)`
  border: 2px var(--gray-7) solid;
  background-color: rgba(255, 255, 255, 0.05); /* transparent dark gray */
  border-radius: 4px;
  width: 100%;
  height: auto;
...
export default function ButtonItem(props: IterableComponent<Props>) {
  ...
  return (
    <StyledButton
      className={[
        'px-4 py-2 d-flex align-center', // Removed gray-8
        loading ? 'flex-start' : 'justify-space-between',
        isSelected ? 'is-active' : '',
      ].join(' ')}
      style={{ color: 'var(--gray-3)' }} // Made the font lighter
