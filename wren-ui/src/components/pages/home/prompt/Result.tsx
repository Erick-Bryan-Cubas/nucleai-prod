...
const Wrapper = ({ children }) => {
  return (
    <StyledResult
      className="border border-gray-9 rounded p-4"
  ...
  return (
    <Wrapper>
      <div className="d-flex justify-space-between">
        ...
        <Button
          className={clsx(
            'adm-btn-no-style bg-gray-9 text-sm px-2',
            loading ? 'gray-5' : 'gray-4',
          )}
          type="text"
          size="small"
    ...
    return (
      <Wrapper>
        <div className="d-flex justify-space-between text-medium mb-2">
          ...
          <Button
            className="adm-btn-no-style gray-4 bg-gray-9 text-sm px-2"
            type="text"
            size="small"
            onClick={onClose}
          >
...
const Understanding = makeProcessing('Entendendo a pergunta');
...
const GeneralAnswer = (props: Props) => {
  ...
  return (
    <Wrapper>
      ...
      <div className="py-3">
        <div className="bg-gray-9 gray-4 py-2 px-3">
          <div className="d-flex align-center">
            <BrainSVG className="mr-2 adm-brain-svg" />
            <span className="text-medium ">Intenção do usuário identificada</span>
          </div>
        ...
        >
          ...
          {isDone && (
            <div className="gray-5">
              <InfoCircleOutlined className="mr-2" />
              Para obter a melhor semântica, revise a página de modelagem.
            </div>
          )}
        </div>
      </div>
