...
export default function TextBasedAnswer(props: AnswerResultProps) {
  ...
  return (
    <StyledSkeleton
      ...
      title={false}
    >
      <div className="text-md py-4 px-6" style={{ color: 'var(--gray-3)' }}>
        ...
        {allowPreviewData ? (
          <div className="mt-6">
            ...
            <div className="mt-2 mb-3" data-guideid="text-answer-preview-data">
              {hasPreviewData && (
                <Text className="text-sm" style={{ color: 'var(--gray-6)' }}>
                  Considerando o limite da janela de contexto, recuperamos até
                  500 linhas de resultados para gerar a resposta.
                </Text>
              )}
              <PreviewData
          ...
          <>
            {!isStreaming && (
              <Alert
                message={
                  <>
                    Clique em <b>Ver SQL</b> para revisar a lógica da consulta passo a passo
                    e verificar por que os dados não estão disponíveis.
                  </>
                }
                type="info"
              />
