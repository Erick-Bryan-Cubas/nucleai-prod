    ...
    <>
      <Form form={form} layout="vertical">
          ...
          <div>
            ...
            >
              <Select
                ...
                placeholder="Selecionar uma tabela"
                showSearch
        ...
        <Loading spinning={isUpdateMode ? dataSourceTablesLoading : false}>
          ...
          >
            <TableTransfer
              ...
              titles={['Colunas disponíveis', 'Colunas selecionadas']}
              showSearch
            />
          </Form.Item>
        </Loading>
        <Form.Item
          label="Selecionar chave primária"
        ...
        >
          <Select
            getPopupContainer={(trigger) => trigger.parentElement!}
            placeholder="Selecionar uma coluna"
            showSearch
            allowClear
          >
